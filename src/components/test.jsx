...
function Test(props) {
  ...
  OutsideClicks(largeScreenRef, () => props.setLargeScreenDropdown(false));

  // Handle outside click for small screen dropdown
  OutsideClicks(smallScreenRef, () => props.setSmallScreenDropdown(false));
            ...
            <div className="flex search-container sm:ml-20 sm:mr-10 lg:mr-20 basis-full border rounded-lg bg-stone-50 h-12  border-stone-300 relative">
              <div ref={largeScreenRef}>
                <button
                  ...
                  onClick={props.toggleLargeScreenDropdown}
                >
                  {props.smallScreenSelected}{" "}
                  <img
                    src={arrowDown}
                ...
                <Categories
                  display={props.largeScreenDropdown ? "flex" : "hidden"}
                  handleClickCategoryItem={props.handleLargeScreenItemClick}
                  top="top-12"
                />
              </div>
              <input
